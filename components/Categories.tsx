...
import { allPizzas, spicyPizzas, vegetarianPizzas, meatPizzas } from '~store/pizza-slice';
  ...
  return (
    <div className="flex flex-col gap-1 p-1 my-2 bg-gray-200 text-blue-600 font-semibold rounded-md">
      <ul className="flex gap-1">
          <li className="w-full">
            <input id={id + '' + 'all'} className="sr-only peer" type="radio" value="all" name="category" defaultChecked onChange={(e) => dispatch(allPizzas(e.target.value))} />
          ...
          <li className="w-full">
            <input id={id + '' + 'spicy'} className="sr-only peer" type="radio" value="spicy" name="category" onChange={(e) => dispatch(spicyPizzas(e.target.value))}/>
          ...
          <li className="w-full">
            <input id={id + '' + 'meat'} className="sr-only peer" type="radio" value="meat" name="category" onChange={(e) => dispatch(meatPizzas(e.target.value))}/>
          ...
          <li className="w-full">
            <input id={id + '' + 'vegetarian'} className="sr-only peer" type="radio" value="vegetarian" name="category" onChange={(e) => dispatch(vegetarianPizzas(e.target.value))}/>
